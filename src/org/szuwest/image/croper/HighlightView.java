...
class HighlightView {
	...
	private void init() {
		...
		mResizeDrawableWidth = resources.getDrawable(R.drawable.common_image_camera_crop_width);
		mResizeDrawableHeight = resources.getDrawable(R.drawable.common_image_camera_crop_height);
		mResizeDrawableDiagonal = resources.getDrawable(R.drawable.common_image_indicator_autocrop);
	}
